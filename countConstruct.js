/*
    PROBLEM: Write a function "countConstruct(target, wordBank)" that accept a target string and an array of strings. Returned a value indicating how many unique ways can we construct the target with the words in the wordBank. return zero if there's no way
*/
...
console.log(
  countConstruct("skateboard", ["skat", "te", "e", "bo", "ard", "ska"])
); // 2
console.log(
